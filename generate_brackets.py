...
:root{--bg:#0e0f11;--sur:#17191d;--brd:#2a2d33;--acc:#c8f135;--acc2:#4af0c4;--txt:#e8eaed;--mut:#6b7280;--win:#4af0c4;--WB:#7dd3fc;--LB:#fdba74;--GF:#d8b4fe}
...
.slot.won .win-btn{background:var(--win);border-color:var(--win);color:#0e0f11}
